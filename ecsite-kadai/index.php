...
<body>
  <header class="header">
    <h1 class="site-title"><a href="#"><img src="images/common/logo_fm1.png" alt="G's Academy Tokyo"></a></h1>
  ...
  <div>
    <ul class="bxslider" ;>
      <li><img src="images/index/bv7.jpg" alt=""></li>
      <li><img src="images/index/bv8.jpg" alt=""></li>
  ...
  <footer class="footer">
    <div class="wrapper wrapper-footer">
      ...
      <div class="footer-widget__long">
        <p><a href="#"><img src="images/common/logo_fm3.png" alt="g's academy tokyo"></a></p>
      </div>
      ...
      <div class="footer-widget">
        <ul class="nav-footer">
          <li class="nav-footer__item"><a href="#">Farmer's Market??</a></li>
